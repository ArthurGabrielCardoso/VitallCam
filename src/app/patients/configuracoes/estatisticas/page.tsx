    ...
    <div className="min-h-full bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button
            onClick={() => router.push('/patients/configuracoes')}
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-700">Estatísticas</h1>
            <p className="text-sm text-gray-400">Sessões de captura da clínica</p>
          </div>
        </div>
